...
```6 awe used: UWUIFY_TOKEN_1744632735238_17 in de Cowwection and UWUIFY_TOKEN_1744632735238_18 in de Asset, which awe de pwints~ De hiewawchy wooks wike dis:
...
Aftew dis setup we can cweate de Cowwection wid UWUIFY_TOKEN_1744632735238_19~ De `maxSupply` fiewd detewminyes how many Editions you want to pwint~ De `name` and `uri` fiewds in de Pwugin can be used in addition to de Cowwection Nyame and uwi.
