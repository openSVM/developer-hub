...
De Auction House account modew can be expwowed in de [API References of the UWUIFY_TOKEN_1744632815796_8 model](https://metaplex-foundation.github.io/js/types/js.AuctionHouse.html).
