...
- `canChangeSalePrice`: dis pawametew is onwy intended to be used on Auction Houses wid UWUIFY_TOKEN_1744632814232_2 set to UWUIFY_TOKEN_1744632814232_3~ Dis awwows de Auction House to pewfowm custom owdew matching to find de best pwice fow de sewwew.
